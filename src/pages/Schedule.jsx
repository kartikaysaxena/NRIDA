...
export function Schedule() {
  return (
    <div className=" my-10">
        <div className="flex justify-center text-center text-4xl font-bold pb-10 mx-auto">Schedule</div>
      ...
      <div className="w-[50vw]">
        <ol className="text-xl flex flex-col gap-4">
          <li className="flex flex-col gap-2">
            <span className="text-4xl font-bold">DAY-1</span>{" "}
            <p>
              {" "}
          ...
          <li className="flex flex-col gap-2">
            <span className="text-4xl font-bold">DAY-2</span>{" "}
            <p>
          ...
          <li className="flex flex-col gap-2">
            <span className="text-4xl font-bold">DAY-3</span>{" "}
            <p>
          ...
          <li className="flex flex-col gap-2">
            <span className="text-4xl font-bold">DAY-4</span>{" "}
            <p>
          ...
          <li className="flex flex-col gap-2">
            <span className="text-4xl font-bold">DAY-5</span>{" "}
            <p>
